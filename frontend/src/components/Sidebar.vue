<template>
	...
	>
		...
		<SidebarSection title="Vegetation Health" icon="fa-solid fa-tree">
		...
		<SidebarSection title="Crop Health" icon="fa-solid fa-seedling">
		...
		<SidebarSection title="Deforestation" icon="fa-solid fa-helmet-safety">
		...
		<SidebarSection title="Water Quality" icon="fa-solid fa-water">
		...
		<SidebarSection title="Coastal Erosion" icon="fa-solid fa-ship">
		...
		<SidebarSection title="Disaster Indicators" icon="fa-solid fa-triangle-exclamation">
		...
		<SidebarSection title="Maritime Features" icon="fa-solid fa-anchor">
